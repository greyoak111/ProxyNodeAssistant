...
if not defined SOURCE_DIR if exist "%~dp0ProxyNodeAssistant-v1.0.0-source\build.ps1" set "SOURCE_DIR=%~dp0ProxyNodeAssistant-v1.0.0-source"

if not defined SOURCE_DIR (
    echo 没有自动找到 ProxyNodeAssistant v1.0.0 源码目录。
