...
if not defined SOURCE_DIR if exist "%~dp0TextNodeAssistant-v0.9.5-source\build.ps1" set "SOURCE_DIR=%~dp0TextNodeAssistant-v0.9.5-source"

if not defined SOURCE_DIR (
    echo 没有自动找到 TextNodeAssistant v0.9.5 源码目录。
...
:bad_source
echo.
echo [ERROR] 该目录不是完整的 TextNodeAssistant 源码目录:
echo %SOURCE_DIR%
