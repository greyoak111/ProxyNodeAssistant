...
if ($archiveVersion -ne "1.0.0" -or $archiveBuildId -ne "20260901-v100-ss2022-r103" -or $archiveBuildRevision -ne "103") {
    throw "Current toolkit archive metadata is not the exact ProxyNodeAssistant v1.0.0 revision-103 build"
}
