...
object ActionCatalog {
    val all = listOf(
        ...
        ActionSpec("22", "CDN / XHTTP 双模式控制中心", "CDN / XHTTP dual-mode control center", "回环预装、公网 8443 Cloudflare-only、人工橙云验证、生产链接与可回滚热切换；Reality 443 始终保留。", "Loopback staging, Cloudflare-only public 8443, manual orange-cloud validation, production links, and rollback-safe hot switching; Reality 443 always remains installed.", ActionGroup.INSTALL),
