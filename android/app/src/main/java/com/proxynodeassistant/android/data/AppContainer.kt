...
class AppContainer(context: Context) {
    ...
    val stableNodes = StableNodeIdentityRepository(vault)
    ...
    val workflows = WorkflowRunner(applicationContext, ssh, managedKeys, targets, prompts, hostKeys, stableNodes)
}
