...
class ProtocolParsersTest {
    ...
    @Test fun completeHandoffPreservesLegacyPrefix() {
        ...
        val complete = ProtocolParsers.completeHandoff(legacy, mapOf("TNA_VERSION" to "0.9.5", "ACTIVE_MODE" to "ACTIVE_DIRECT"))
    ...
    @Test fun cdnXHttpLinkParserIsStrict() {
        val link = "vless://11111111-1111-4111-8111-111111111111@edge.example.com:8443?encryption=none&security=tls&sni=edge.example.com&fp=chrome&type=xhttp&host=edge.example.com&path=%2F0123456789abcdef0123456789abcdef%2F&mode=packet-up#TNA-CDN-XHTTP-STAGE"
	...
	@Test fun stableNodeIdentityAndPublicIpv4AreStrict() {
		val value = "${ProtocolParsers.NODE_IDENTITY_BEGIN}\n" +
			"SERVER_ID=tna-srv-0123456789abcdef0123456789abcdef\n" +
		...
		assertEquals("tna-node-0123456789abcdef0123456789abcdef", ProtocolParsers.stableNodeIdentity(value, "root@old:22").nodeId)
