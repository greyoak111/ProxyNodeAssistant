...
class InstallPlanTest {
    ...
    fun explicitGrayFreshPlanUsesFixedPortsAndNoAssumeDefaults() {
        ...
        val env = plan.environmentValues("root", "zh", "/tmp/text-node-assistant-auto-input-0123456789abcdef01234567.env")
    ...
    fun previewMasksEmailButShowsExplicitChoices() {
        ...
        assertTrue("PORT_PRESET=reality:443 shadow:24443 cdn:8443 warp:40000" in review)
    }
