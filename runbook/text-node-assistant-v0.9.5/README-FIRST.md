...
> v0.9.5 新增可回滚的硬件自适应性能档、vnStat 流量计数、回环 CDN/XHTTP 实验阶段和固定供应链的 copyparty 私人网盘。默认生产模式仍为 REALITY 直连；橙云使用受 Cloudflare 免费计划支持的公网 8443，Reality 继续占用 443。详见 `CHANGELOG-v0.9.5.md`。
...
```text
读取 VPS /etc/text-node-assistant/public.env
