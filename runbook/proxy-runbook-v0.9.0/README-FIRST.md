# Proxy Node Assistant / Runbook v0.9.0

> v0.9.0 新增可回滚的硬件自适应性能档与 vnStat 流量计数接口；Windows 端另提供 KiwiVM/条件式服务商 API 流量中心。15 套本地伪装站、登录、ACME、key 管理与失败关闭能力全部保留。详见 `CHANGELOG-v0.9.0.md`。
