...
# Retired device-admission and private-drive state is intentionally not
# migrated.  The one-time upgrade worker (00c-retire-v095-device-drive.sh)
# handles only ownership-marked legacy services; ordinary user data is never
# adopted, mounted, or deleted by this bootstrap migration.
