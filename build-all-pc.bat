...
set "OUTPUT_DIR=%SOURCE_DIR%outputs\TextNodeAssistant-v0.9.5-official"

echo ============================================================
echo  TextNodeAssistant v0.9.5 reset line - Windows 全架构正式打包
echo ============================================================
